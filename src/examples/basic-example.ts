...
console.log("Mobile button data is valid:", Schema.is(MobileButton)(mobileButtonData))
...
console.log("Desktop button data is valid:", Schema.is(DesktopButton)(desktopButtonData))

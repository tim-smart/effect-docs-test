...
try {
  const createProduct = Schema.decodeUnknownSync(Product.create)(createProductData)
  console.log("Create product validated:", createProduct)
  
  const updateProduct = Schema.decodeUnknownSync(Product.update)(updateProductData)

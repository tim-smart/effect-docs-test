...
console.log(
  ...
  Schema.is(ProductionConfig)(productionConfig),
)

// Demonstrate decoding/encoding
console.log(
  "Decoded dev config:",
  Schema.decodeUnknownSync(DevConfig)(devConfig),
)
console.log(
  "Decoded production config:",
  Schema.decodeUnknownSync(ProductionConfig)(productionConfig),
)
